createDirec <- function(folderChanged){
  ...
  globalCleaner <- function(folderChanged){
  ####################################################
  # Load in all the Files to the Environment
  ...
  remove('lead')
  ############################################## End of Leads Cleaning
  
  ################################################## Begin Contact File CleanUp
  ...
  remove(account)
  ############################################## End of accounts Cleaning
  
  ############################################## Start of opportunity Cleaning
  ...
  ############################################## End of opportunity Cleaning
  
  ############################################## Start of Note Cleaning
  ...
  remove('note')
  ############################################## End of Note Cleaning
  
  ############################################## Start of Task Cleaning
